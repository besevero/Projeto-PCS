...
public class TelaPagament extends javax.swing.JFrame {

    /**
     * Creates new form TelaPagament
     */
    private DefaultListModel modeloPedido = new DefaultListModel();
     Pedido u = new Pedido(1);
    
    public TelaPagament(Pedido t) {
       
        initComponents();
        u=t;
        listaPgto.setModel(modeloPedido);
        //double totalCompra=0;
        for(int i = 0; i<u.getPratos().size();i++){
            modeloPedido.addElement((u.getPratos().get(i).getNome() + " ------- " + u.getPratos().get(i).getValor()));
            
         /*  double aux= Double.parseDouble(getValor(u.getPratos(get(i))));
            
            totalCompra= totalCompra+ aux; */
        }
         //totalPedido.setText("R$ " + String.valueOf( totalCompra));
    ...
    private void ticketActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ticketActionPerformed
        TelaCartao TelaCartao = new TelaCartao(u);
    ...
    private void voltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_voltarActionPerformed
        TelaPedido TelaPedido = new TelaPedido(u);
        TelaPedido.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_voltarActionPerformed

    private void cancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelarActionPerformed
        TelaInicial TelaInicial = new TelaInicial(u);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPagament.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new TelaPagament().setVisible(true);
            }
        });
    }
